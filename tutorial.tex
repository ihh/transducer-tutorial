...
We first describe the sorts of state machines used, beginning
 ...
 (which appear at the leaves of the tree in \figref{cs-mf-liv-tree}) 
...
\end{tabular}
\caption{ \tablabel{tkf91-tkf91} Meaning of states in
...
\end{tabular}
\caption{ \tablabel{mf-substituter} Meaning of states in
...
\end{tabular}
\caption{ \tablabel{mf-tkf91} Meaning of states in
...
\end{tabular}
\caption{ \tablabel{tkf91-mf} Meaning of states in
