...
\item \figref{null} is a ``null model'' generator that emits a single IID sequence
...
\pdffig{null}{A simple null-model generator with geometric length parameter $p$ and residue frequency distribution $\pi$.}
...
\pdffig{tkf91-tkf91}{Composition of TKF91 model (\pdffig{tkf91-labeled}) with itself.}
...
\pdffig{mf-tkf91}{Composition of MF-generator (\figref{mooore-mf-generator}) with TKF91 transducer (\figref{tkf91-labeled})}
