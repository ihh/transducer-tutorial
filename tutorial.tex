...
To allow this, the transition weights for all the collapsed transitions must factorize into independent emission- and transition-associated components.
In this example (corresponding to \figref{fanned-emission}), the emission weights are $U(y)$ for insertions, $Q(x,y)$ for substitutions and $V(x)$ for deletions;
