...
An approximate affine-gap transducer, based on the work of \cite{KnudsenMiyamoto2003} and \cite{Rivas05}, is shown in \figref{protpal}.

\pdffig{protpal}{An approximate affine-gap transducer.
Note that in contrast to \figref{tkf91-labeled}, this machine requires two Wait states ($W$ and $X$),
in order to preserve the ``memory'' of being inside a deletion.
