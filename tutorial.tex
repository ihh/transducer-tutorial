...
described in \secref{ModelStructure}.
...
G_2 & = & (\tkf \cdot G_3) \fork (\tkf \cdot G_4) & \\
& = & ( \tkf \cdot \recognize(LIV) ) \fork ( \tkf \cdot \recognize(MF) ) & \mbox{\figref{fork-tkf91liv-tkf91mf}} \\
H_2 & = & (\tkf \cdot E_3) \fork (\tkf \cdot E_4) & \\
& = & G_2 & \mbox{\figref{fork-tkf91liv-tkf91mf} again} \\
M_2 & = & \tkfroot \cdot H_2 & \\
...
G_1 & = & (\tkf \cdot G_2) \fork (\tkf \cdot G_5) & \\
...
H_1 & = & (\tkf \cdot E_2) \fork (\tkf \cdot E_5) & \mbox{\figref{fork-tkf91viterbi-tkf91cs}, \figref{fork-tkf91forward2-tkf91cs}} \\
G_0 & = & \tkfroot \cdot G_1 & \\
...
\forall n \in \{1,2\}: Q_n & = & \tkfroot \fork (\tkf \cdot \tkf) & \mbox{\figref{root-fork-tkf91-tkf91}} \\
\end{array}
\]
