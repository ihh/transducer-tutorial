...
Our simulation study is comprised of alignments simulated  using 5 different indel rates $\lambda$ (0.005, 0.01, 0.02, 0.04, and 0.08 indels per unit time), each with 3 different substitution rates (0.5, 1, and 2 expected  substitutions per unit time) and 100 replicates.  
