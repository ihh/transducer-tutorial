...
in our countably-infinite vector space.
The exact-match generator $\recognize(S)$ resembles a unit column-vector in the $S$-direction,
while $\generate(S)$ resembles a unit row-vector in the $S$-direction.
