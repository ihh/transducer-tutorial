...
we now have generic labels like {\tt x/y} representing the set of all substitutions; the actual characters (and their weights) are encoded by the emission functions.
