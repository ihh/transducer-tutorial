...
\newcommand{\widepdffig}[2]{\easyfig{#1.pdf}{width=\textwidth}{#1}{#2}}
\newcommand{\tallpdffig}[2]{\easyfig{#1.pdf}{height=\textheight}{#1}{#2}}
...
% should be \imath_X instead of \delta_X when it's a generator
