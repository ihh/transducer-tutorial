...
We can note a few obvious results:
if $T$ is a generator then $TU$ is a generator;
if $U$ is a recognizer then $TU$ is a recognizer.
% crossref
...
\subsubsection{An ancestral sequence recognizer on a larger TKF91 tree}
