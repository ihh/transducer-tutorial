...
in \figref{root-fork-tkf01liv-tkf91mf}.  
...
the size of the state space when we begin to apply these concepts not just to pairs of 
sequences, but entire phylogenetic trees.  
...
\tallpdffig{viterbi-profile}{Transducer $\profile_1$...}
...
\tallpdffig{forward2-profile}{Transducer $\profile_2$...}
