...
For completeness, we give constructions of composition (\secref{Composition}) and intersection (\secref{Fork}) for Mealy machines (I/O associated with transitions).
