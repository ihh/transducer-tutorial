...
\figref{mf-tkf91-liv}, like \figref{mf-substituter-cs}, contains only null states (no match, insert, or delete states), making it a pure Markov chain.  
...
The second operation for connecting two transducers
 is one that we call ``intersection''.
% crossref
Intersection is described in greater detail in \secref{Fork}. 

Intersection Of two transducers is to feed the same input tape into both transducers in parallel.
...
\subsubsection{Intersection of substituter-CS with substituter-MF}
...
\subsubsection{Composition of simple prior with intersection of substituter-MF and substituter-CS}
...
\subsubsection{Intersection of TKF91-LIV with TKF91-MF}
...
\subsubsection{Composition of simple prior with intersection of TKF91-MF and TKF91-LIV}
...
\subsubsection{Intersection of TKF91-CS with (fork of TKF91-LIV and TKF91-MF)}
...
The resulting transducer is in weak-normal form (it can be converted to a strict-normal form transducer by eliminating null states).
% crossref
In the tutorial section, many examples of simple and complex intersections are shown in \secref{Tutorial.Fork}, for instance \figref{fork-subcs-submf} and  \figref{root-fork-tkf91liv-tkf91mf}. 
